...
% Si el algoritmo no identifica la parte de la cara hay que cambiar valores
...
% valores atípicos
outliers = [1:3]; % aqui se indica los indices de los valores atipicos, ingresados a mano
...
%% PREPROCESAMIENTO 3 - PRE-WHITENING
[X,W] = prewhiten(X1);
%%
